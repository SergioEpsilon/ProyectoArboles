...
class BST:
    ...
    # Metodo para imprimir el peso de un nodo, que es la cantidad de nodos en su subárbol incluyendo él mismo
    def getWeightNode(self, node):
        if node is None:
            return 0
        else:
            return self.__getWeightNode(node)
